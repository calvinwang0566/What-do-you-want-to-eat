...
# 讀取food panda資料
import pandas as pd
df = pd.read_csv("panda.csv",encoding = 'Big5')
...
class Food(tk.Frame):
    ...
    def createWidgets(self):
        ...
        ok2 = ok.resize( (120, 40), Image.BILINEAR )
        ok2.save( "ok2.png" )
    ...
    def clickBtn(self):
        ...
        try:    # 若有符合所有條件的
            ...
            # 跳出小視窗推薦
            messagebox.showinfo("推薦你吃！", message=df_random["店名"].to_string(index = False)+"\n(總共"+ str(total) + "項中1項)")
